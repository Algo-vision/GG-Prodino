...
// is now one of the horizontal axes - this remaps a raw (x,y,z) reading
// (works for both accelerometer and gyroscope vectors) from sensor-native
// axes into the standing-equivalent logical axes the rest of the firmware
// (calibration, orientation math) expects. Applied identically to both
// IMUs, independent of their fixed 180-degree relationship to each other.
