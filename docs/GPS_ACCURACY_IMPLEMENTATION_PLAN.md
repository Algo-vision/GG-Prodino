...
#### [MODIFY] [i2c_imu_gps.hpp](file:///home/haim/repos/GG/GG-Prodino/lib/GG/src/i2c_imu_gps.hpp)
...
#### [MODIFY] [i2c_imu_gps.cpp](file:///home/haim/repos/GG/GG-Prodino/lib/GG/src/i2c_imu_gps.cpp)
...
#### [MODIFY] [status_manager.hpp](file:///home/haim/repos/GG/GG-Prodino/include/status_manager.hpp)
- Add `float gpsHAcc`, `float gpsVAcc`, `double gpsAltEllipsoid` to `DeviceStatus` struct

#### [MODIFY] [status_manager.cpp](file:///home/haim/repos/GG/GG-Prodino/src/status_manager.cpp)
...
#### [MODIFY] [mqtt_handler.hpp](file:///home/haim/repos/GG/GG-Prodino/include/mqtt_handler.hpp)
- Add `float hAcc, float vAcc, double altEllipsoid` params to `publishGPS()`
- Publish new MQTT topic `prodino/{sn}/gps/accuracy` → `{"hAcc": ..., "vAcc": ..., "altEllipsoid": ...}`

#### [MODIFY] [main.cpp](file:///home/haim/repos/GG/GG-Prodino/src/main.cpp)
...
#### [MODIFY] [main_widget.py](file:///home/haim/repos/GG/GG-Prodino/test/main_widget.py)
...
#### [MODIFY] [gg_api_tester.py](file:///home/haim/repos/GG/GG-Prodino/test/gg_api_tester.py)
...
#### [MODIFY] [server.js](file:///home/haim/repos/GG/GG-Prodino/prodino_web_ui/server.js)
...
#### [MODIFY] [index.html](file:///home/haim/repos/GG/GG-Prodino/prodino_web_ui/public/index.html)
...
#### [MODIFY] [app.js](file:///home/haim/repos/GG/GG-Prodino/prodino_web_ui/public/app.js)
...
#### [MODIFY] [mqtt_subscriber.py](file:///home/haim/repos/GG/GG-Prodino/mqtt_server/mqtt_subscriber.py)
- Add `"accuracy"` key to `latest_data["gps"]` (line 29)
- Add `elif topic == "prodino/gps/accuracy":` handler
...
#### [MODIFY] [platformio.ini](file:///home/haim/repos/GG/GG-Prodino/platformio.ini)
...
#### [MODIFY] [README.md](file:///home/haim/repos/GG/GG-Prodino/README.md)
...
- Add `prodino/gps/accuracy` MQTT topic
...
2. Check MQTT topic `prodino/{sn}/gps/accuracy`
